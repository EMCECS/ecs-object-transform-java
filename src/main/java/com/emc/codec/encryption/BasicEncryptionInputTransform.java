...
import com.emc.codec.TransformConstants;
import com.emc.codec.TransformException;
...
public class BasicEncryptionInputTransform extends EncryptionInputTransform {
    ...
    /* (non-Javadoc)
     * @see InputTransform#decodeInputStream(java.io.InputStream)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see InputTransform#decodeMetadata(java.util.Map)
     */
    @Override
